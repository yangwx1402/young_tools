...
public class KMeansWebPage {

	public static void main(String[] args) throws Exception {
		Tokenized tokenized = new MapFileTokenized(
				"F:\\tfidf_model\\webpage\\dic.txt");
		...
		Map<String, List<WeightWord>> tfidf = vectorized.computeTfIdf(tf, idf,
				true);
		tokenized.saveDic();
		vectorized.saveModel("F:\\tfidf_model\\webpage", tf, idf, tfidf);
