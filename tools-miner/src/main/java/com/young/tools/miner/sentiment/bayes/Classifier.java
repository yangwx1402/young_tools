package com.young.tools.miner.sentiment.bayes;
...
import com.young.tools.miner.sentiment.common.Constants.SentimentType;
import com.young.tools.miner.sentiment.common.Constants.WordType;
import com.young.tools.miner.sentiment.terms.NGramGenerator;
...
public class Classifier {
	...
	public static void main(String[] args) {
		System.out.println(Classifier.class.getResource("/").getPath());
		Classifier cls = new Classifier();
	
		String text = "祝贺#友谊佛山店#荣获2012佛山诚信商场称号！[赞]感谢你们的支持和信赖！广州友谊商店矢志努力，让广大消费者“体验尊贵，共享友谊”！";
		//String text = "宝贝收到了,好玩又实惠,好评";
