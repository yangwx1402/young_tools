 ...
 *
 */
package com.young.tools.common.util.http.entity;
...
public class UrlFormEntity extends StringEntity {

    /**
     * Constructs a new {@link UrlFormEntity} with the list
